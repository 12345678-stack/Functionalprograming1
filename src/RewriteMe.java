...
public class RewriteMe {
    ...
    public List<String> getListOfAllQuestions(){
        ...
        //throw new UnsupportedOperationException("Not supported yet.");
        return questions.stream().map(q->q.getQuestionString()).collect(Collectors.toList());
    }
    ...
    public List<String> getAllQuestionStringsBelongingACategory(Category category){
        //throw new UnsupportedOperationException("Not supported yet.");
        return questions.stream().filter(q->q.getCategory().equals(category)).map(q->q.getQuestionString()).collect(Collectors.toList());
    ...
    public List<String> getAllAnswerOptionsDistinct(){
        //throw new UnsupportedOperationException("Not supported yet.");
        return questions.stream().flatMap(a -> a.getAllAnswers().stream()).distinct().collect(Collectors.toList());
    ...
    public boolean isThisAnAnswerOption(String answerCandidate){
        //throw new UnsupportedOperationException("Not supported yet.");
        return questions.stream().anyMatch(a->a.getAllAnswers().contains(answerCandidate));
    ...
    public int getAnswerCandidateFrequncy(String answerCandidate){
        ...
        //throw new UnsupportedOperationException("Not supported yet.");
        return (int) questions.stream().filter(q -> q.getAllAnswers().contains(answerCandidate)).count();
    ...
    {
        //throw new UnsupportedOperationException("Not supported yet.");
        return  questions.stream().filter(q->q.getCategory().equals(c)).flatMap(q->q.getAllAnswers().stream()).reduce("",(u,e)->u.length()>e.length()?u:e);
//
    }
