...
public class RewriteMeTest {
    ...
    @Test
    public final void getAmountOfQuestionsInDatabaseTest(){
        assertEquals(6, x.getAmountOfQuestionsInDatabase());
    }

    @Test
    public final void getListOfAllQuestionsTest(){
    ...
    @Test
    public final void getAmountOfQuestionsForACertainCategoryTest(){
    ...
    @Test
   public   final void getAllAnswerOptionsDistinctTest(){
    ...
    @Test
   public   final void getAllQuestionStringsBelongingACategoryTest(){
     ...
     @Test
    public final void isThisAnAnswerOption(){
    ...
    @Test
   public    final void getAnswerCandidateFrequncyTest(){
    ...
    @Test
   public   final void getQuestionGroupedByCategoryTest() {
    ...
    @Test
   public   final void getLongestLettercountAnwerInAGivenCategoryTest(){
